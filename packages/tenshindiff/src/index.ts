...
export { stripRuby, toKana, parseRubyUnits, matchesByRubyUnits, type RubyMatchOptions } from './ruby';
export {
  parseAnswerTemplate,
  generateAnswers,
...
export { speechTextFromDiffOps, speechTextFromRubyNotation, type SpeechTextMode } from './speech';
