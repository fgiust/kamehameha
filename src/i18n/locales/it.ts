const it = {
  common: {
    ...
    answerUndone: 'La tua risposta è stata annullata',
    forms: 'Forme:',
    kanji: 'Kanji',
    furigana: 'Furigana ⇧',
    type: 'Tipo',
  ...
  pages: {
    ...
    transitiveDrop: { title: 'Caduta transitivi' },
  ...
  transitiveDrop: {
    ...
    score: 'Punti',
    level: 'Lv',
    helpMove: 'cambia corsia',
    helpSoft: 'discesa veloce',
    helpHard: 'caduta istantanea',
    helpFurigana: 'mostra/nascondi furigana',
    furiganaToggle: 'Furigana',
    furiganaOn: 'ON',
    furiganaOff: 'OFF',
    helpStart: 'avvia / riprova',
    readyTitle: 'INSERT COIN',
    readyBody: 'Fai cadere ogni verbo in Transitivo (sinistra) o Intransitivo (destra). Gli errori si accatastano: se riempi lo schermo è game over!',
    start: 'Premi Start',
    gameOver: 'GAME OVER',
    finalScore: 'Punteggio {{score}}',
    tryAgain: 'Svuota le pile e riprova.',
