...
export const genki03Lessons: TranslateSessionData[] = [
  {
    id: 'genki3-2',
    ...
    sentenceData: [
      ...
      { english: 'He reads books.', answer: '彼[かれ]は本[ほん]を読[よ]みます' },
    ],
  },
  {
    id: 'genki3-3',
  ...
  },
  {
    ...
    sentenceData: [
      { english: 'I study Japanese every day.', answer: '{私[わたし]は|}毎[まい]日[にち]日[に]本[ほん]語[ご]を勉[べん]強[きょう]します' },
  ...
  },
  {
    ...
    title: '～ませんか',
    sentenceData: [
      { english: 'Would you like to eat lunch?', answer: '昼[ひる]ご飯[はん]を食[た]べませんか' },
      { english: 'Would you like to watch a movie together?', answer: '一[いっ]緒[しょ]に映[えい]画[が]を見[み]ませんか' },
      { english: 'Will you study in the library with me?', answer: '一[いっ]緒[しょ]に図[と]書[しょ]館[かん]で勉[べん]強[きょう]しませんか' },
      { english: 'Would you like to drink coffee at a cafe?', answer: '喫[きっ]茶[さ]店[てん]でコーヒーを飲[の]みませんか' },
      { english: 'Would you like to watch TV at my house?', answer: 'うちでテレビを見[み]ませんか' },
    ],
  },
  {
    id: 'genki3-7',
    ...
    sentenceData: [
      ...
      { english: 'I usually study at home.', answer: 'たいてい家[いえ]で勉[べん]強[きょう]します' },
    ],
  },
];
