...
export const genki09Lessons: TranslateSessionData[] = [
  {
    id: 'genki9-2',
  ...
  },
  {
    ...
    title: 'まだ～ていません',
    sentenceData: [
      { english: 'I have not eaten lunch yet.', answer: '{私[わたし]は|}まだ昼[ひる]ご飯[はん]を食[た]べていません' },
      { english: 'Sue has not woken up yet.', answer: 'スーさんはまだ起[お]きていません' },
      { english: 'I have not done my homework yet.', answer: '{私[わたし]は|}まだ宿[しゅく]題[だい]をしていません' },
      { english: 'Mary has not come yet.', answer: 'メアリーさんはまだ来[き]ていません' },
      { english: 'He has not taken a bath yet.', answer: '彼[かれ]はまだお風[ふ]呂[ろ]に入[はい]っていません' },
    ],
  },
  {
    id: 'genki9-4',
